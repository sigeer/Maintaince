...
- [x] 更新备份，回滚
- [x] 更新时，定制的处理，比如额外要执行的命令，脚本...(清理注册表，停止应用再更新...)
- [ ] 移除powershell脚本调用时的其他输出
- [ ] powershell的依赖，根据不同系统使用不同版本：windows使用process调用，非windows使用powershell.sdk调用